...
如果您被邀请参与投稿或已通过申请（持有维护者发放的**邀请密码**），请直接在此处上传：
 **[投稿工作站](/contribute/workstation)**

验证密码后填写专辑名称、选择整张专辑的原料
（歌词文本 / 歌词本图片 / 音频 / Staff 表 / 封面）直接提交，完全无需 Git。
系统会自动处理并开出 PR，审核通过即自动入库。
